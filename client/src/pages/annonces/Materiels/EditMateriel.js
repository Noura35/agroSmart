      ...
      <div className="col-lg-8 col-xl-6" >
        <div className="card rounded-3" id="cont1">
          ...
          <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1" >
            <Form.Control as="textarea" rows={3} placeholder="description d'équipement" htmlFor="description" style={{ border: " 3px solid #def8ca" }} value={description} onChange={e=>setDescription(e.target.value)}  />
